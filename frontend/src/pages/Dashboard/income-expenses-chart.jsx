...
const IncomeVsExpensesChart = ({ darkMode }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/profile/income-expense-trend?n=${n}`,
        {
          method: "GET",
          headers: {
  ...
  const averageMonthlySavings = Math.round(
    (totalIncome - totalExpenses) / data.length
  );
    ...
    if (active && payload && payload.length) {
      return (
        ...
        >
          ...
          <p className="text-sm">
            <span className="font-medium text-green-500">Income:</span> $
            {payload[0].value.toLocaleString()}
          </p>
          <p className="text-sm">
            <span className="font-medium text-red-500">Expenses:</span> $
          ...
          <div className="grid grid-cols-3 gap-2 mt-1">
            <div className="text-center">
              ...
              <p className="font-medium text-green-500">
                ${hoveredBar.income.toLocaleString()}
              </p>
            </div>
            <div className="text-center">
              <p
              ...
              <p className="font-medium text-red-500">
                ${hoveredBar.expenses.toLocaleString()}
              </p>
            </div>
            <div className="text-center">
              <p
