    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className={`relative w-full max-w-md p-6 rounded-lg shadow-lg ${darkMode ? "bg-gray-800" : "bg-white"}`}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className={`block text-sm ${darkMode ? "text-gray-300" : "text-gray-600"} mb-1`}>Payment Method*</label>
            <select
        ...
        <div className="mb-4">
          ...
          {currentExpense.isRecurring && (
            <div className="mt-2">
              <label className={`block text-sm ${darkMode ? "text-gray-300" : "text-gray-600"} mb-1`}>Recurring Period</label>
              <select
