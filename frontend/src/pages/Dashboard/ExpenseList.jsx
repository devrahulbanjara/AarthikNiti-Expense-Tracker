    ...
    <div className={`p-4 rounded-lg border ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-300"}`}>
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Manage your expenses</p>
        </div>
        ...
        <table className="w-full">
          <thead>
            <tr className={`${darkMode ? "bg-gray-700" : "bg-gray-100"}`}>
              ...
              <th className="px-4 py-2 text-left font-medium text-sm">Payment Method</th>
            ...
            {sortedExpenses.length === 0 ? (
              ...
              sortedExpenses.map(expense => (
                ...
                >
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center">
                      <Calendar className={`h-4 w-4 mr-2 ${darkMode ? "text-gray-300" : "text-gray-700"}`} />
                      {new Date(expense.date).toLocaleDateString()}
                    </div>
                  </td>
                  <td className="px-4 py-4">
                    <div className="flex items-center">
                      <CreditCard className={`h-4 w-4 mr-2 ${darkMode ? "text-gray-300" : "text-gray-700"}`} />
