    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            <h1 
              className="text-4xl font-bold tracking-tight text-[#065336] sm:text-5xl md:text-6xl"
              data-aos="fade-right"
            >
              Your Personal <span className="text-[#0a7a56]">Finance</span> Manager
            </h1>
            <p 
            ...
            >
              ...
              <a
                href="#features"
                className="flex items-center gap-2 rounded-md border border-[#065336] px-6 py-3 text-[#065336] hover:bg-[#065336] hover:text-white transition-all"
              >
                Learn More
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-white p-8 rounded-lg shadow-sm border hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                data-aos="fade-up"
      ...
      <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32 bg-[#065336]/5">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 
              className="text-3xl font-bold text-[#065336]"
              data-aos="fade-up"
            >
              What Our Users Say
            </h2>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <div 
                className="inline-block rounded-lg bg-[#065336]/10 px-3 py-1 text-sm text-[#065336]"
                data-aos="fade-up"
              >
                Features
              </div>
              ...
              <p 
                ...
                data-aos-delay="200"
              >
                AarthikNiti provides a comprehensive set of tools to help you track, analyze, and optimize your personal finances.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              <ul className="grid gap-6">
                {[
                  {
                    icon: <ArrowUpRight className="h-5 w-5 text-[#065336]" />,
                    title: "Financial Dashboard",
                    description: "Get a complete overview of your financial health with our intuitive dashboard."
                  },
                  {
                    icon: <BarChart3 className="h-5 w-5 text-[#065336]" />,
                    title: "Income Tracking",
                    description: "Monitor all your income sources and analyze earnings over time."
                  },
                  {
                    icon: <PieChart className="h-5 w-5 text-[#065336]" />,
                    title: "Expense Breakdown",
                    description: "Categorize and visualize your spending patterns to identify saving opportunities."
                  }
                ].map((item, index) => (
                  <li 
                    key={index}
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <details 
                key={index} 
                className="group bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-all duration-300"
                data-aos="fade-up"
  ...
  <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
    <div className="flex flex-col justify-center space-y-4">
      <div className="space-y-2">
        ...
        <p 
          className="max-w-[600px] text-[#e0e0e0] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed"
          data-aos="fade-right"
          data-aos-delay="100"
        >
      ...
      >
        <button
          onClick={handleSignUp}
          className="inline-flex h-10 items-center justify-center rounded-md bg-white px-8 text-sm font-medium text-[#065336] shadow transition-all hover:bg-gray-100 hover:scale-105"
        >
          Get Started
        ...
        <a
          href="#features"
          className="inline-flex h-10 items-center justify-center rounded-md border border-white px-8 text-sm font-medium text-white shadow-sm transition-all hover:bg-white hover:text-[#065336]"
        >
          Learn More
        </a>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="space-y-4">
        ...
        <p className="text-gray-300">
          Your personal finance manager to track, analyze, and optimize your financial health.
        </p>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#faq" className="text-gray-300 hover:text-white transition-colors">Help Center</a></li>
        </ul>
      </div>
