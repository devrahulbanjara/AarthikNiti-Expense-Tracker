...
const AppHeader = ({ title, subtitle, darkMode, toggleDarkMode, handleLogout, scrolled }) => {
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 ${darkMode ? "bg-gray-900" : "bg-white"} z-30 p-6 transition-all duration-300 ${scrolled ? `${darkMode ? "bg-opacity-80" : "bg-opacity-90"} backdrop-blur-sm border-b ${darkMode ? "border-gray-700" : "border-gray-200"}` : "bg-opacity-100"}`}>
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-4">
                    <button className={`p-2 rounded-full ${darkMode ? "bg-gray-800 hover:bg-gray-700" : "bg-gray-200 hover:bg-gray-300"} cursor-pointer`} onClick={toggleDarkMode}>
                    ...
                    <div className="relative profile-dropdown-container">
                        ...
                        {showProfileDropdown && (
                            <div className={`absolute right-0 mt-2 w-48 rounded-md border py-1 z-10 ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-300"}`}>
                                <Link
                                    to="/profile"
