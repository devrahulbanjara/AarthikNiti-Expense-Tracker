  ...
  const chartRef = useRef(null)
    ...
    const fetchExpenseBreakdownData = async () => {
        try {
            ...
            console.log("Expense Data from Backend:", data);
    ...
    return (
        <div className={`${darkMode ? "bg-gray-800" : "bg-white"} p-4 rounded-lg border ${darkMode ? "border-gray-700" : "border-gray-300"} h-full w-full max-w-md`} ref={chartRef} onMouseMove={handleMouseMove}>
                ...
                <>
                    <div className="h-[220px] mb-4 relative">
                        ...
                        {showTooltip && tooltipData && (
                            <div
                                className={`absolute ${darkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"} border rounded-md p-3 z-20 transition-opacity duration-300 ease-in-out`}
                                style={{
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {expenseBreakdownData.map((entry, index) => {
                            ...
                            return (
                                <div
                                    key={`legend-${index}`}
                                    className={`flex items-center gap-2 cursor-pointer ${darkMode ? "hover:bg-gray-700" : "hover:bg-gray-50"} p-1 rounded transition-all duration-200 ${activeIndex === index ? "scale-105 font-medium" : ""}`}
